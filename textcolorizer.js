...
function textcolorizer_handle() {
    ...
    if (update==1) {
        ...
        str_html="";
        str_style="";
        if (input_bold==1) {str_style+="font-weight:bold;";}
        if (input_italic==1) {str_style+="font-style:italic;";}
        if (input_font!="") {str_style+='font-family:"'+input_font+'";';}
        if (input_size!="0") {
            var str_size;
            str_size=""
        ...
        if (input_effect=="1") {
            ...
            str_html+="<font color="+input_color8+">"+input_text+"</font>"
